...
function Nav(data, func) {
	...
	var default_show = function(qd) {
		$(".nav").hide()					// hide all pages
		document.body.scrollIntoView();		// jump to top of document
		var f = window[ "nav_" + qd.act ]
		if( typeof f === "function" ) {
			// a global function exists to handle the page; call it
			f( qd )
		}
	}
	...
	if(!Nav.show) {
		// first time through 
		Nav.show = func || default_show; //function(){}
		var doc = document
